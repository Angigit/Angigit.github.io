...
function getPreviousCard() {
    getServerData("http://my-json-server.typicode.com/angigit/angigit.github.io/cards").then(
        data => {
...
function createUser() {
    ...
    fetch("http://my-json-server.typicode.com/angigit/angigit.github.io/cards", fetchOptions).then(
